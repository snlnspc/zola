...
use config::Config;
use library::{Library, Taxonomy, SerializingPage};
...
impl Function for Trans {
    fn call(&self, args: &HashMap<String, Value>) -> Result<Value> {
        let translations_config = &self.config.translations;
...
//pub fn make_get_page(library: &Library) -> Function {
//    let mut pages = HashMap::new();
//    for page in library.pages_values() {
//        pages.insert(
...
//}
//
//pub fn make_get_section(library: &Library) -> Function {
...
//}
//
//pub fn make_get_url(permalinks: HashMap<String, String>, config: Config) -> Function {
//    Box::new(move |args| -> Result<Value> {
//        let cachebust =
...
//}
//
//pub fn make_get_taxonomy(all_taxonomies: &[Taxonomy], library: &Library) -> Function {
...
//}
//
//pub fn make_get_taxonomy_url(all_taxonomies: &[Taxonomy]) -> Function {
//    let mut taxonomies = HashMap::new();
//    for taxonomy in all_taxonomies {
...
//}
//
//pub fn make_resize_image(imageproc: Arc<Mutex<imageproc::Processor>>) -> Function {
